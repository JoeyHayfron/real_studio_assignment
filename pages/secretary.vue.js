var Secretary = {
  ...
  <div class="container-sm main-content">
    <div class="row left-and-right">
        ...
        <router-link class="nav-link" to="/"><a href="#" class="left-buttons">Presidential</a></router-link>
        <router-link class="nav-link" to="/vice"><a href="#" class="left-buttons">Vice Preisdent</a></router-link>
        <router-link class="nav-link" to="/secretary"> <a href="#" class="left-buttons active">Secretary</a></router-link>
        </div>
